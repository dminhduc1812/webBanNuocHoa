...
{
    public partial class XoaDatHang : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(strConnection))
            {
                SqlCommand cmd = new SqlCommand
                    ("delete from DatHang where IDDatHang = @IDDatHang", conn);
                conn.Open();
                cmd.Parameters.AddWithValue("@IDDatHang", pID.ToString());
